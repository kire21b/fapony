---
name: plan-with-me
description: Draft a plan + spec from "what's in your head" through conversation. Soft tone. Use with Claude Code / OpenCode / Codex / ZCode. Trigger on /plan-with-me and when the user asks to plan or brainstorm a feature.
---
...
When all answers are in → write the plan according to **plan core** (separate file)
Then ask:
